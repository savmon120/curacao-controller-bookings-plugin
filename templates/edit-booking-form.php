 ...
 * Location: wp-content/plugins/curacao-atc-bookings/templates/edit-booking-form.php
 */
?>
...
<div id="editBookingModal" class="modal" style="display:none;">
  <div class="modal-content">
    ...
    <form method="post" id="editBookingForm">
      <?php wp_nonce_field('curacao_update_booking', 'curacao_update_nonce'); ?>
      ...
      <div class="form-row">
        ...
        <select name="start_time" id="edit_start_time" required>
          <?php echo Curacao_ATC_Validation::time_options(); ?>
        </select>
      </div>
